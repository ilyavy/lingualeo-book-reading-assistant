 ...
 */
public class WordWithAtomicCounter implements Comparable<WordWithAtomicCounter>, Jsonable {
    /**
     ...
     */
    public WordWithAtomicCounter(final String word, final String translate) {
        this(word);
     ...
     */
    @Override
    public int compareTo(final WordWithAtomicCounter that) {
    ...
    public boolean equals(final Object o) {
        if (!(o instanceof WordWithAtomicCounter)) {
            return false;
        }
        WordWithAtomicCounter that = (WordWithAtomicCounter) o;
     ...
     */
    public static Comparator<WordWithAtomicCounter> countOrder() {
        return new CountComparator();
    }
    ...
    protected static class CountComparator
            implements Comparator<WordWithAtomicCounter> {
        /**
         ...
         */
        @Override
        public int compare(final WordWithAtomicCounter o1, final WordWithAtomicCounter o2) {
            Long c1 = o1.count.get();
            Long c2 = o2.count.get();
